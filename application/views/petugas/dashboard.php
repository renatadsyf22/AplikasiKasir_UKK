...
<div id="slideshow" class="carousel slide" data-ride="carousel">
  ...
  <a class="carousel-control-next" href="#slideshow" role="button" data-slide="next">
    ...
    <div id="transactionCountDisplay"></div>
    ...
    <div class="card-body">
        <div class="row no-gutters align-items-center">
            <div class="col mr-2">
                <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">Jumlah Transaksi</div>
                <div class="h5 mb-0 font-weight-bold text-gray-800" id="transactionCountDisplay">-</div> 
            </div>
            <div class="col-auto">
...
$(document).ready(function() {
    // Fungsi untuk mengambil jumlah transaksi dari server
    function fetchTransactionCount(startDate, endDate) {
        $.ajax({
            url: 'backend_endpoint.php', // Ganti dengan URL titik akhir backend Anda
            method: 'GET',
            data: {
            ...
            success: function(response) {
                // Tampilkan jumlah transaksi ke dalam elemen dengan ID 'transactionCountDisplay'
                $('#transactionCountDisplay').text(response.transactionCount);
            },
    ...
    // Panggil fungsi fetchTransactionCount saat halaman dimuat
    fetchTransactionCount('', ''); // Panggil dengan tanggal awal dan akhir default
});
