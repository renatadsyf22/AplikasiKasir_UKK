...
<head>
    ...
    <style>
        ...
        .button-card {
            ...
            margin: 0 5px;
            /* Mengurangi margin antar tombol */
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">
                    <h5>Cash Register<sup>Lite</sup> </h5>
                </div>
            ...
            <li class="nav-item ">
                <a class="nav-link collapsed" href="<?= base_url('petugas/pelanggan'); ?>">
            ...
            <li class="nav-item ">
                <a class="nav-link collapsed" href="<?= base_url('petugas/produk'); ?>">
                    <i class="fas fa-fw fa-boxes"></i>
                    <span>Produk</span></a>
            </li>
            <!-- <li class="nav-item ">
                <a class="nav-link collapsed" href="<?= base_url('petugas/kategori'); ?>">
                    <i class="fas fa-fw fa-bookmark"></i>
                    <span>Kategori</span></a>
            </li> -->
            <li class="nav-item ">
                <a class="nav-link collapsed" href="<?= base_url('petugas/transaksi'); ?>">
                    <i class="fas fa-fw fa-desktop"></i>
                    <span>Transaksi</span></a>
            </li>
            <li class="nav-item ">
                <a class="nav-link collapsed" href="<?= base_url('petugas/keranjang'); ?>">
                    <i class="fas fa-fw fa-shopping-cart"></i>
                    <span>Keranjang</span></a>
            </li>

            <!-- <li class="nav-item ">
                <a class="nav-link collapsed" href="<?= base_url('petugas/penjualan'); ?>">
                    <i class="fas fa-fw fa-shopping-cart"></i>
            ...
            <li class="nav-item ">
                <a class="nav-link collapsed" href="<?= base_url('petugas/detailpenjualan'); ?>">
            ...
            <!-- <li class="nav-item ">
                <a class="nav-link collapsed" href="<?= base_url('petugas/user/index'); ?>">
                    <i class="fas fa-fw fa-user-check"></i>
                    <span>Users</span></a>
            </li> -->

            <li class="nav-item ">
                <a class="nav-link collapsed" href="<?= base_url('petugas'); ?>" data-toggle="modal" data-target="#logoutModal">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div class="button-container">
                        <div class="button-card">
                            <a href="<?= base_url('petugas'); ?>"></a>
                            <span id="current-menu"></span> <!-- Tempat untuk menampilkan menu saat ini -->
                        </div>

                        <!-- Tambahkan tombol menu lainnya di sini -->
                    </div>
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="<?= base_url('petugas'); ?>" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="img-profile rounded-circle" src="<?= base_url('assets/'); ?>img/user.jpg" style="max-width: 60px">
                                <span class="ml-2 d-none d-lg-inline text-gray-600 small"><?php echo $user['name']; ?></span>
                            </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Renata De Syifa <?= date('Y'); ?></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
