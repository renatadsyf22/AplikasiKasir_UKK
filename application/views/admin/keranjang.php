...
<form class="form-inline" action="<?= site_url('admin/keranjang') ?>" method="post">
...
<div class="row">
	...
	<button type="button" class="btn btn-warning ml-2" id="btnReset">
    <i class="fa fa-sync"></i> RESET KERANJANG
</button>
        ...
        if (result.isConfirmed) {
            Swal.fire({
                ...
                if (result.isConfirmed || result.dismiss === Swal.DismissReason.close) {
                    ...
                    window.location.href = "<?php echo site_url('admin/deletekeranjang/')?>" +
                    TransaksiID;
                }
            });
        }
