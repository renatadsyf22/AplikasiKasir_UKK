...
<body>
        ...
        <?php foreach ($DetailPenjualan as $detail): ?>
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-title">Nama Produk: <?php echo $NmProduk; ?></div>
    ...
    <script>
        ...
        dateFilterForm.addEventListener('submit', function(event) {
            ...
            dateRangeText.textContent = `Data dari tanggal ${startDate} sampai ${endDate}`;
            // Lakukan proses pengiriman data filter ke controller di sini
        });
    </script>
</body>
</html>
