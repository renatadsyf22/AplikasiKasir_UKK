    ...
    public function index()
{
    if($this->session->userdata('akses')=='admin'){
        ...
        $data['content'] = 'admin/dashboard'; // Assuming you have a dashboard view
...
public function updateDataProduk()
{
    ...
    public function deletekeranjang($TransaksiID)
    {
        ...
        // Redirect ke halaman master setelah penghapusan
            redirect(site_url('admin/keranjang'));
    ...
    public function transaksi()
    {
        ...
        $data['content'] = 'admin/transaksi'; // Assuming you have a transaksi view
        $this->load->view('admin/page', $data);
    }
    public function keranjang()
    {
        ...
        $data['content'] = 'admin/keranjang'; // Assuming you have a transaksi view
        $this->load->view('admin/page', $data);
    }
...
public function export_pdf_detailpenjualan() {
    ...
    $this->custompdf->load_view('admin/ExportPdf', $data);
}
...
public function detailpenjualan()
{
    ...
    // Set view
    $data['content'] = 'admin/detailpenjualan'; 
    $this->load->view('admin/page', $data);
}
...
public function deleteDetail($DetailID)
{
    ...
    // Redirect ke halaman master setelah penghapusan
        redirect(site_url('admin/detailpenjualan'));
